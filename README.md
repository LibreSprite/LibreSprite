...
## Download
Grab an [AppImage](https://github.com/LibreSprite/LibreSprite/releases/tag/continuous) for Linux, macOS [App](https://github.com/LibreSprite/LibreSprite/releases) or get the [Windows Portable](https://github.com/LibreSprite/LibreSprite/releases/tag/v1.2-973d0e3d).
