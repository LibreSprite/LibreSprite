...
FOR_EACH_COMMAND(AlternateTimeline)
FOR_EACH_COMMAND(AlternateTouchbar)
FOR_EACH_COMMAND(AlternateToolbar)
...
FOR_EACH_COMMAND(OpenScriptsFolder)
...
FOR_EACH_COMMAND(ResetSymmetry)
...
FOR_EACH_COMMAND(ToggleFullscreen)
FOR_EACH_COMMAND(TogglePreview)
FOR_EACH_COMMAND(ToggleTouchbar)
